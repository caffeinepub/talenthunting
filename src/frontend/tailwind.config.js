  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        gold: "0 4px 24px -4px oklch(0.78 0.155 65 / 0.35)",
        navy: "0 8px 32px -8px oklch(0.22 0.055 258 / 0.4)",
        card: "0 2px 20px -4px oklch(0.22 0.055 258 / 0.12)",
        "card-hover": "0 8px 40px -8px oklch(0.22 0.055 258 / 0.2)",
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
